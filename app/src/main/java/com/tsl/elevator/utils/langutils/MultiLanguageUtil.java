...
//        try {
//            ArrayList<LanguageContent> values = (LanguageContent>) LanguageContent.arrayLanguageContentFromData(json);
//            if (values.isEmpty()) {
//                return "";
//            }
...
//                if (language.equals(values.get(i).getLanType())) {
...
//        }
//    }
    public static String getZHValue(String json) {
        try {
            ArrayList<LanguageContent> values = (ArrayList<LanguageContent>) LanguageContent.arrayLanguageContentFromData(json);
            if (values.isEmpty()) {
                return "";
            }
            String key = "zh-CN";
            for (int i = 0; i < values.size(); i++) {
                if (key.equals(values.get(i).getLanType())) {
                    return values.get(i).getValue();
                }
            }
            return "";
    ...
    public static String getENValue(String json) {
        try {
            ArrayList<LanguageContent> values = (ArrayList<LanguageContent>) LanguageContent.arrayLanguageContentFromData(json);
            if (values.isEmpty()) {
                return "";
            ...
            String keyEn = "en";
            for (int i = 0; i < values.size(); i++) {
                if (key.equals(values.get(i).getLanType()) || keyEn.equals(values.get(i).getLanType())) {
                    return values.get(i).getValue();
                }
            }
            return "";
